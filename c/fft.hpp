...
class FFT {
    ...
    void reversePermutation(Element *a, u_int64_t n, u_int32_t nThreads);
...
public:
    ...
    FFT(u_int64_t maxDomainSize);
    ~FFT();
    void fft(Element *a, u_int64_t n, u_int32_t nThreads );
    void ifft(Element *a, u_int64_t n, u_int32_t nThreads );
